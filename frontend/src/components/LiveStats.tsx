...
export default function LiveStats() {
  ...
  return (
    <section className="grid grid-cols-1 gap-3 sm:grid-cols-3">
      <article className="rounded-xl border border-[#1a1a1a] bg-[#080d16] px-4 py-4 transition-shadow duration-200 hover:shadow-[0_0_28px_rgba(0,132,255,0.18)]">
        <p className="text-3xl font-bold tracking-tight text-[#24a0ff]">
          🎯 {displayedStats.total_leads_all_time.toLocaleString()} leads found
        </p>
        <p className="mt-2 text-xs uppercase tracking-[0.12em] text-slate-400">Across all campaigns</p>
      </article>
      ...
      <article className="rounded-xl border border-[#1a1a1a] bg-[#080d16] px-4 py-4 transition-shadow duration-200 hover:shadow-[0_0_28px_rgba(0,132,255,0.18)]">
        ...
        <p className="mt-2 text-xs uppercase tracking-[0.12em] text-slate-400">Tracked deliveries</p>
      </article>
      ...
      <article className="rounded-xl border border-[#1a1a1a] bg-[#080d16] px-4 py-4 transition-shadow duration-200 hover:shadow-[0_0_28px_rgba(0,132,255,0.18)]">
        ...
        <p className="mt-2 text-xs uppercase tracking-[0.12em] text-slate-400">Running right now</p>
      </article>
    </section>
  );
}
